function upDate(selectedImg){
    ...
    */
    document.getElementById('image').style.backgroundImage = "url(" + selectedImg.src + ")";
    document.getElementById('image').innerHTML = selectedImg.alt;
}
   
function unDo(){
    /* In this function you should
       1) Update the url for the background image of the div with the id = "image" back to the orginal-image.
            You can use the css code to see what that original URL was.
