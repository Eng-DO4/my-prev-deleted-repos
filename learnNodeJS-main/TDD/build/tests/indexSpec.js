...
it("should get basic data on the country canada", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, main_1.default.getCountry('canada')];
            case 1:
                data = _a.sent();
                expect(data).toEqual({
                    capital: 'Ottawa',
...
it("should get the countries in the region NAFTA", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, main_1.default.getRegionCountries('nafta')];
            case 1:
                data = _a.sent();
                expect(data).toEqual([
...
it("should get capitals of NAFTA countries", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, main_1.default.getRegionCapitals('nafta')];
            case 1:
                data = _a.sent();
                expect(data).toEqual([
